...
- Реализуйте следующий функционал:
    ...
    - Фильтр с выбором:
        ...
        - Фильтры по платформе, браузерам и операционным системам, о которых будет отображена информация.
