...
Мы хотим чтобы Вы реализовали вывод подобных статистических данных в таблицу c возможностью сгруппировать данные, применить фильтры, а также создали возможность постраничной навигации.

![scheme](docs/scheme.png "Scheme")
<p style="text-align: center;"><i>Схематичное представление задания.</i></p>
